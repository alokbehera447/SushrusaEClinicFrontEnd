      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className={`space-y-6 sm:space-y-8 ${isVisible ? 'animate-fade-in-left' : 'opacity-0'}`}>
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 sm:space-x-3 glass px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-soft hover-glow group cursor-pointer animate-slide-in-down">
              ...
              <span className="text-xs sm:text-sm font-bold text-[#E17726] tracking-wide">RURAL HEALTHCARE</span>
            </div>
            
            {/* Main Heading */}
            <div className="space-y-4 sm:space-y-6 animation-delay-200">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-midnight leading-[0.9] tracking-tight">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-600 leading-relaxed animate-fade-in-up animation-delay-300">
                ...
                <div className="relative rounded-2xl overflow-hidden mb-3 sm:mb-4 group-hover:scale-105 transition-transform duration-500">
                  ...
                  <div className="w-full h-48 sm:h-64 md:h-72 bg-gradient-to-br from-[#E17726]/20 to-cyan-400/20 flex items-center justify-center rounded-2xl">
                    <div className="text-center space-y-4">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-orange rounded-full flex items-center justify-center mx-auto shadow-xl">
                        <Video className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                      </div>
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-midnight mb-1">Professional Centers</h3>
